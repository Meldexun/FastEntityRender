...
import meldexun.fastentityrender.renderer.CubeDataProvider;
...
public interface IModelBox extends CubeDataProvider {

	default void bufferCube(MatrixStack matrixStack, float scale, IVertexConsumer vertexConsumer) {
